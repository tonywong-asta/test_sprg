	...
	def _stock_account_get_anglo_saxon_price_unit(self):
		...
		if so_line:
			...
			for prd in self.product_id.pack_ids:
				average_price_unit = prd.product_id._compute_average_price(qty_invoiced, qty_to_invoice, so_line.move_ids.filtered(lambda s: s.product_id.id == prd.product_id.id))
